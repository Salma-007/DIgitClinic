...
<head>
  ...
  <title>Nouveau Patient - Clinique Digitale</title>
  <style>
    :root {
      --primary: #3498db;
      --secondary: #2c3e50;
    ...
    <form action="patients" method="post">
      ...
      <div class="form-group">
        ...
        <input type="email" id="email" name="email" class="form-control"
               placeholder="email@patient.com" required>
      </div>
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <input type="number" id="poid" name="poid" class="form-control"
                 step="0.1" min="20" max="300" placeholder="Ex: 70.5" required>
        </div>
        ...
        <div class="form-group">
          ...
          <input type="number" id="taille" name="taille" class="form-control"
                 step="0.1" min="100" max="250" placeholder="Ex: 175" required>
        </div>
      </div>
